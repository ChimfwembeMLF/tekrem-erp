...
/*
|--------------------------------------------------------------------------
| ERP Application Routes (Tenant Context)
|--------------------------------------------------------------------------
|
| All ERP application routes are defined here. This file is loaded by
| routes/tenant.php which applies the tenant initialization middleware,
| so every route here runs within an active tenant context.
|
| The outer auth middleware group wraps all ERP routes that require login.
|
*/
...
Route::middleware([
    ...
    Route::prefix('admin')->name('admin.')->middleware('role:admin|super_user')->group(function () {
        ...
        Route::post('users/bulk-import', [\App\Http\Controllers\Admin\UserController::class, 'bulkImport'])->name('users.bulk-import');
    ...
    Route::prefix('projects')->name('projects.')->middleware('permission:view projects')->group(function () {
        ...
        Route::post('/{project}/ai-milestones', [\App\Http\Controllers\ProjectController::class, 'generateAIMilestonesApi'])->name('ai-milestones');
        Route::post('/{project}/ai-insights', [\App\Http\Controllers\ProjectController::class, 'aiInsights'])->name('ai-insights');
    ...
    Route::prefix('finance')->name('finance.')->middleware('permission:view finance')->group(function () {
        ...
        // Bank Reconciliation (alias prefix)
...
// Social Media Webhooks (no auth required — tenant context)
