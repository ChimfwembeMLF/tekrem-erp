...
export default function Index({ invoices, recent_payments, recent_quotations, stats, filters }: Props) {
                            ...
                            <CardContent>
                                ...
                                {invoices.length >= 5 && (
                                    <div className="text-center mt-6">
                                        <Link href={route('customer.finance.invoices')}>
                    ...
                    <div className="space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                    ...
                                    {recent_quotations && recent_quotations.length > 0 ? (
                                        recent_quotations.map((quotation) => (
                                            <div key={quotation.id} className="flex items-center justify-between p-3 border rounded-lg">
                                                ...
                                                <Badge variant={quotation.status === 'accepted' ? 'secondary' : 'default'}>
                                                    {quotation.status}
                                                </Badge>
                                            </div>
                                        ))
                                ...
                                {recent_quotations && recent_quotations.length > 0 && (
                                    <div className="text-center mt-4">
                                        <Link href={route('customer.finance.quotations')}>
                                            <Button variant="outline" size="sm">
                                                View All Quotations
                                            </Button>
                                        </Link>
