                    ...
                    <div className="space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-2">
                                <Link href={route('customer.projects.tasks', project.id)} className="block">
                                    <Button variant="outline" className="w-full justify-start">
                                        <Target className="mr-2 h-4 w-4" />
                                        View All Tasks
                                    </Button>
                                </Link>
                                <Link href={route('customer.projects.milestones', project.id)} className="block">
                                    <Button variant="outline" className="w-full justify-start">
                                        <Target className="mr-2 h-4 w-4" />
                                        View Milestones
                                    </Button>
                                </Link>
                                <Link href={route('customer.projects.time-tracking', project.id)} className="block">
                                    <Button variant="outline" className="w-full justify-start">
                                        <Clock className="mr-2 h-4 w-4" />
                                        Time Tracking
                                    </Button>
                                </Link>
                                <Link href={route('customer.projects.files', project.id)} className="block">
                                    <Button variant="outline" className="w-full justify-start">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-2">
                                <Link href={route('customer.projects.chat', project.id)} className="block">
                                    <Button variant="outline" className="w-full justify-start">
