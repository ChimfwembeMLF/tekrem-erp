...
interface CreatePerformanceProps {
  employees: Employee[];
  reviewers: Reviewer[];
}

export default function CreatePerformance({ employees = [], reviewers = [] }: CreatePerformanceProps) {
  ...
  return (
    <AppLayout title="Create Performance Review">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={e => setData('review_start_date', e.target.value)}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={e => setData('review_end_date', e.target.value)}
                ...
                <div className="flex items-center gap-2">
                  <Checkbox id="is_self_review" checked={data.is_self_review} onCheckedChange={checked => setData('is_self_review', !!checked)} />
                  <Label htmlFor="is_self_review" className="font-medium">Self Review</Label>
                </div>
                <Button type="submit" disabled={processing}>Save Review</Button>
              </CardContent>
            </Card>
          </form>
        </div>
