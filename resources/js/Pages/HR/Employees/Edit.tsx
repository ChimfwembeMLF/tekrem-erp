...
interface EditEmployeeProps { employee: Employee; departments: Department[]; users: User[]; }

export default function EditEmployee({ employee, departments = [], users = [] }: EditEmployeeProps) {
