                ...
                <div className="relative w-full max-w-sm md:max-w-md mb-4">
                    <AnimatePresence initial={false} custom={direction} mode="wait">
                        <motion.div
                            ...
                            className="border-secondary/40 shadow-sm hover:shadow-md transition-shadow duration-300 bg-card text-card-foreground dark:bg-card dark:text-card-foreground rounded-2xl p-6 md:p-8 w-full flex flex-col items-center z-20"
