...
class SetupController extends Controller
{
    ...
    public function updateAttendance(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'office_radius_meters' => 'nullable|integer|min:10|max:5000',
    ...
    private function getPayrollSettings(): array
    {
        return [
            ...
            'auto_generate_payroll' => Setting::get('hr.payroll.auto_generate_payroll', true),
    ...
    private function getAttendanceSettings(): array
    {
        return [
            ...
            'require_clock_in_location' => Setting::get('hr.attendance.require_clock_in_location', true),
            'office_name' => Setting::get('hr.attendance.office_name', 'Main Office'),
            'office_latitude' => Setting::get('hr.attendance.office_latitude', -15.3875),
            'office_longitude' => Setting::get('hr.attendance.office_longitude', 28.3228),
            'office_radius_meters' => Setting::get('hr.attendance.office_radius_meters', 150),
