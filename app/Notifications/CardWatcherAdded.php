...
class CardWatcherAdded extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('New Card Watcher Added')
            ->greeting('Hello ' . $notifiable->name . '!')
            ->line($this->watcher->name . ' is now watching your card: ' . $this->card->title)
